    ...
    <div class="bg-base-100 drawer drawer-mobile">
        ...
        <div class="drawer-side">
            ...
            <ul class="menu pt-0 w-80 bg-base-200">
                <li>
                    <router-link to="/" class="btn btn-ghost normal-case text-xl" style="min-height: 4rem">{{ appName
                    }}</router-link>
                </li>
                <li :class="{ bordered: route.name.match('home') }">
                    <router-link :to="{ name: 'home' }"><i class="fa-solid fa-house me-2"></i>ホーム</router-link>
                </li>
                <li :class="{ bordered: route.name.match('users') }">
                    <router-link :to="{ name: 'users' }"><i class="fa-solid fa-users me-2"></i>団員リスト</router-link>
                </li>
                <li :class="{ bordered: route.name.match('accountings') }">
                    <router-link :to="{ name: 'accountings' }"><i class="fa-solid fa-wallet me-2"></i>集金リスト</router-link>
                </li>
            </ul>
        </div>
        <!-- End of Sidebar -->
